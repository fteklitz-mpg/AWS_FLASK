...
class Student:
    ...
    def __init__(self, name, grades):
        ...
        self.grades = grades # grades parameter defines grades object property
...
print('#########################################\n') 
student = Student('Bob', (100, 100, 93, 78, 90) )  # variable declaration calls the class, running the __init__ method and allocating memory to properties and methods
...
student = Student('Ron', (90, 90, 93, 78, 90) )  # variable declaration calls the class, running the __init__ method and allocating memory to properties and methods
